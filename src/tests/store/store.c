...
static void btree_insert(struct btree *btree, int64_t key, char *value) {
  ...
  int64_t* var_EofWnN6bhD_0;int64_t var_EofWnN6bhD_1;int64_t var_EofWnN6bhD_2;((var_EofWnN6bhD_0 = ((int64_t*)(((char*)(new_node)) + (0)))),(var_EofWnN6bhD_1 = *((int64_t*)(pm_read_object(var_EofWnN6bhD_0)))),(var_EofWnN6bhD_2 = (key)),pm_write_object(var_EofWnN6bhD_0,((char*)(&var_EofWnN6bhD_2)),sizeof(int64_t)),var_EofWnN6bhD_2);
  pm_write_object(((char*)(((char*)((new_node)))+24)),value,strlen(value)+1);

  struct btree_node ** var_EofWnN6bhD_3;struct btree_node * var_EofWnN6bhD_4;struct btree_node * var_EofWnN6bhD_5;((var_EofWnN6bhD_3 = ((struct btree_node **)(((dst)) + (0)))),(var_EofWnN6bhD_4 = *((struct btree_node **)(pm_read_object(var_EofWnN6bhD_3)))),(var_EofWnN6bhD_5 = (new_node)),pm_write_object(var_EofWnN6bhD_3,((char*)(&var_EofWnN6bhD_5)),sizeof(struct btree_node *)),var_EofWnN6bhD_5);
}

...
static void btree_insert(struct btree *btree, int64_t key, char *value) {
  ...
  while (*((struct btree_node **)pm_read_object(dst)) != (NULL)) {
    dst =
        ((struct btree_node *
              *)((char *)((*((struct btree_node **)pm_read_object(dst)))) + 8) +
  ...
  int64_t *var_h3lCzQK5fo_3;
  int64_t var_h3lCzQK5fo_4;
  int64_t var_h3lCzQK5fo_5;
  ((var_h3lCzQK5fo_3 = (int64_t *)((char *)(new_node) + (0))),
   (var_h3lCzQK5fo_4 = *(int64_t *)pm_read_object(var_h3lCzQK5fo_3)),
   (var_h3lCzQK5fo_5 = (key)),
   pm_write_object(var_h3lCzQK5fo_3, (char *)&var_h3lCzQK5fo_5,
                   sizeof(int64_t)),
   var_h3lCzQK5fo_5);
  pm_write_object(((char *)(new_node) + (24)), value, strlen(value) + 1);

  struct btree_node **var_h3lCzQK5fo_6;
  struct btree_node *var_h3lCzQK5fo_7;
  struct btree_node *var_h3lCzQK5fo_8;
  ((var_h3lCzQK5fo_6 = (struct btree_node **)((dst) + (0))),
   (var_h3lCzQK5fo_7 = *(struct btree_node **)pm_read_object(var_h3lCzQK5fo_6)),
   (var_h3lCzQK5fo_8 = (new_node)),
   pm_write_object(var_h3lCzQK5fo_6, (char *)&var_h3lCzQK5fo_8,
  ...
  while (node != (NULL)) {
    if (((struct btree_node *)pm_read_object(node))->key == key)
      ...
      node = ((struct btree_node **)pm_read_object(
          (struct btree_node *
               *)((char *)(node) +
                  8)))[key > ((struct btree_node *)pm_read_object(node))->key];
  }
...
static void btree_foreach(struct btree *btree, struct btree_node *node,
  ...
  long *var_h3lCzQK5fo_0;
  long var_h3lCzQK5fo_1;
  long var_h3lCzQK5fo_2;
  ((var_h3lCzQK5fo_0 = (long *)((char *)(node) + (0))),
   (var_h3lCzQK5fo_1 = *(long *)pm_read_object(var_h3lCzQK5fo_0)),
   (var_h3lCzQK5fo_2 = (var_h3lCzQK5fo_1 + 10)),
   pm_write_object(var_h3lCzQK5fo_0, (char *)&var_h3lCzQK5fo_2, sizeof(long)),
   var_h3lCzQK5fo_2);
...
static void btree_print(struct btree *btree) {
  btree_foreach(btree, ((struct btree *)pm_read_object(btree))->root,
                btree_node_print);
}

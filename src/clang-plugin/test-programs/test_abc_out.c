...
void pm_store_run() {
    ...
    for (int i = 0; i<10000*100000; i++) {
        int* var_Y7UhXxRymd_0;int var_Y7UhXxRymd_1;int var_Y7UhXxRymd_2;((var_Y7UhXxRymd_0 = ((int*)(((((int*)(((char*)((root)))+0)))) + (i%rounds)))),(var_Y7UhXxRymd_1 = *((int*)(pm_read_object(var_Y7UhXxRymd_0)))),(var_Y7UhXxRymd_2 = (i)),pm_write_object(var_Y7UhXxRymd_0,((char*)(&var_Y7UhXxRymd_2)),sizeof(int)),var_Y7UhXxRymd_2);
    }
}
void pm_store_close() {
    pm_close();

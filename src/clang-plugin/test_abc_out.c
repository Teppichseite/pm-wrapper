...
int pm_store_init(char *path, char *path1, char *path2) {
    ...
    ;
    PmRegionConfig region_config1 = {.file_path=path1,.root_size=sizeof(struct holder)};
    pm_region_reference_id ref1 = pm_init_reg(region_config1);
    PmRegionConfig region_config2 = {.file_path=path2,.root_size=sizeof(struct holder)};
...
void pm_store_run() {
    int rounds = 1000;
    for (int i = 0; i<10000*rounds; i++) {
        int* var_kxRc7yWIzX_0;int var_kxRc7yWIzX_1;int var_kxRc7yWIzX_2;((var_kxRc7yWIzX_0 = ((int*)(((((int*)(((char*)((root1)))+0)))) + (i%rounds)))),(var_kxRc7yWIzX_1 = *((int*)(pm_read_object(var_kxRc7yWIzX_0)))),(var_kxRc7yWIzX_2 = (i)),pm_write_object(var_kxRc7yWIzX_0,((char*)(&var_kxRc7yWIzX_2)),sizeof(int)),var_kxRc7yWIzX_2);
        int* var_kxRc7yWIzX_3;int var_kxRc7yWIzX_4;int var_kxRc7yWIzX_5;((var_kxRc7yWIzX_3 = ((int*)(((((int*)(((char*)((root2)))+0)))) + (i%rounds)))),(var_kxRc7yWIzX_4 = *((int*)(pm_read_object(var_kxRc7yWIzX_3)))),(var_kxRc7yWIzX_5 = (i)),pm_write_object(var_kxRc7yWIzX_3,((char*)(&var_kxRc7yWIzX_5)),sizeof(int)),var_kxRc7yWIzX_5);
    }
}
void pm_store_close() {
    pm_close();
